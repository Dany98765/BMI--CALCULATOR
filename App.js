    ...
    return (
        <div>
            ...
            <form>
                ...
                <h4>Your BMI indicates you're weight is <h4  className="state">{BMI <= 18.5 && "UnderWeight" || BMI <= 24.9 && "Normal" || BMI <= 29.9 && "Overweight" || BMI <= 34.9 && "Obese" || BMI >= 34.9 && "Extremely Obese"}</h4></h4>
            </form>
        </div>
    )
}
